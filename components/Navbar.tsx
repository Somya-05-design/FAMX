...
export function Navbar() {
  return (
    <div className="sticky top-3 sm:top-4 z-50 flex justify-center w-full px-4 pt-2 sm:pt-3 pointer-events-none">
      <header className="pointer-events-auto inline-flex items-center space-x-6 sm:space-x-8 bg-surface-container-lowest/40 backdrop-blur-lg backdrop-saturate-150 border border-outline-variant/50 rounded-full px-5 sm:px-7 py-3 transition-all shadow-md shadow-black/5 hover:bg-surface-container-lowest/60">
