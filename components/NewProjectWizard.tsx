  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-between text-xs font-semibold text-zinc-500 mt-2 px-1">
          <span>Category</span>
      ...
      {step === 1 && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-zinc-900">Select Project Category</h2>
            <p className="text-sm text-zinc-500">Choose the type of service you need, or select 'Other' for custom work</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {services.map((service) => (
              ...
              >
                <div className="flex items-center space-x-3 mb-2">
                  <div className={`p-2 rounded-lg ${formData.serviceId === service.id ? "bg-black text-white" : "bg-zinc-100 text-zinc-600"}`}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            >
              <div className="flex items-center space-x-3 mb-2">
                <div className={`p-2 rounded-lg ${formData.serviceId === "other" ? "bg-black text-white" : "bg-zinc-100 text-zinc-600"}`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                  </svg>
                </div>
                <h3 className="font-bold text-zinc-900">Other / Custom Service</h3>
              </div>
              <p className="text-xs text-zinc-500 leading-relaxed">Need something not listed? Select this and describe it in the next step.</p>
            </button>
          </div>
          ...
          {formData.serviceId === "other" && (
            <div className="pt-4 animate-fadeIn">
              ...
              <input
                ...
                className="w-full bg-zinc-50 border border-zinc-200 focus:border-black focus:bg-white rounded-xl px-4 py-3 text-sm text-zinc-900 outline-none transition-all"
              />
            </div>
          )}
        </div>
      ...
      {step === 2 && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-zinc-900">Project Requirements</h2>
            <p className="text-sm text-zinc-500">Describe what you need in detail. Upload briefs, brand guides, or wireframes.</p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-zinc-50 border border-zinc-200 focus:border-black focus:bg-white rounded-xl px-4 py-3 text-sm text-zinc-900 outline-none transition-all resize-none"
              />
            </div>
            ...
            <div>
              ...
              <div className="border border-dashed border-zinc-300 hover:border-zinc-400 rounded-xl p-6 bg-zinc-50 text-center flex flex-col items-center justify-center relative cursor-pointer group">
                <input
                  type="file"
                ...
                />
                <div className="p-3 bg-white rounded-full text-zinc-500 group-hover:text-zinc-900 transition-colors mb-3 shadow-xs border border-zinc-200">
                  {isUploading ? (
                    <span className="w-6 h-6 border-2 border-zinc-400 border-t-black rounded-full animate-spin block" />
                  ) : (
                ...
                <p className="text-sm font-semibold text-zinc-800">Click to upload file</p>
              ...
              {uploadedFiles.length > 0 && (
                <div className="mt-4 space-y-2">
                  {uploadedFiles.map((file) => (
                    <div key={file.id} className="flex items-center justify-between p-3 bg-white border border-zinc-200 rounded-xl text-xs shadow-xs">
                      <div className="flex items-center space-x-2.5 truncate">
                        ...
                        <span className="text-zinc-800 font-medium truncate">{file.fileName}</span>
      ...
      {step === 3 && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-zinc-900">Budget & Timeline</h2>
            <p className="text-sm text-zinc-500">Specify your non-binding proposed budget and desired delivery timeline tier.</p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  min="1"
                  step="0.01"
                  className="w-full bg-zinc-50 border border-zinc-200 focus:border-black focus:bg-white rounded-xl pl-8 pr-4 py-3 text-sm text-zinc-900 outline-none transition-all"
                />
              </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-zinc-600 uppercase tracking-wider mb-3">
                Expected Timeline
              </label>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <h4 className="font-bold text-sm text-zinc-900">{item.label}</h4>
            ...
            {formData.timelineTier === TimelineTier.CUSTOM_DATE && (
              <div className="animate-fadeIn">
                ...
                <input
                  ...
                  className="bg-zinc-50 border border-zinc-200 focus:border-black focus:bg-white rounded-xl px-4 py-3 text-sm text-zinc-900 outline-none transition-all"
                />
              </div>
            )}
          </div>
      ...
      {step === 4 && (
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold text-zinc-900">Review & Submit</h2>
            <p className="text-sm text-zinc-500">Please verify your details before submitting your request to our team.</p>
          </div>

          <div className="bg-zinc-50 border border-zinc-200/80 rounded-2xl p-6 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <p className="text-sm font-semibold text-zinc-900 mt-1">{formData.title}</p>
              </div>
              <div className="col-span-2">
                <p className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold">Description</p>
                <p className="text-xs text-zinc-700 mt-1 whitespace-pre-wrap leading-relaxed">{formData.description}</p>
              </div>
              {formData.requirements && (
                <div className="col-span-2">
                  <p className="text-[10px] text-zinc-500 uppercase tracking-wider font-semibold">Additional Specs</p>
                  <p className="text-xs text-zinc-700 mt-1 whitespace-pre-wrap leading-relaxed">{formData.requirements}</p>
                </div>
              )}
              <div>
      ...
      <div className="flex justify-between items-center mt-10 pt-6 border-t border-zinc-200">
        {step > 1 ? (
          <button
            ...
            className="px-6 py-2.5 rounded-lg text-sm font-semibold border border-zinc-200 text-zinc-700 hover:bg-zinc-100 transition-colors disabled:opacity-50 cursor-pointer"
          >
            Back
          </button>
        ) : (
        ...
        {step < 4 ? (
          <button
            onClick={nextStep}
            className="px-6 py-2.5 rounded-lg text-sm font-bold bg-black hover:bg-zinc-800 text-white transition-colors cursor-pointer shadow-xs"
          >
            Continue
          </button>
        ) : (
          <button
            ...
            disabled={isSubmitting}
            className="px-6 py-2.5 rounded-lg text-sm font-bold bg-black hover:bg-zinc-800 text-white transition-all shadow-xs flex items-center justify-center space-x-2 disabled:opacity-50 cursor-pointer"
          >
            {isSubmitting ? (
