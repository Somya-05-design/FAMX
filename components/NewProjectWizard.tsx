          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {services.map((service) => {
              ...
              return (
                <button
                  ...
                  className={`p-5 text-left rounded-xl border transition-all duration-200 cursor-pointer flex flex-col justify-between ${
                ...
                >
                  <div>
                    <div className="h-32 w-full mb-3 rounded-lg overflow-hidden bg-[#f4eee4] relative flex items-center justify-center border border-outline-variant/20">
                      <img
                        src={getCategoryImg(service.name)}
                        alt={service.name}
                    ...
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <h3 className="font-bold text-on-surface text-sm">{service.name}</h3>
                    </div>
            ...
            >
              <div>
                <div className="h-32 w-full mb-3 rounded-lg overflow-hidden bg-[#f4eee4] relative flex items-center justify-center border border-outline-variant/20">
                  <img
                    src="/services/custom-request.png"
                    alt="Other / Custom Service"
                    className="w-full h-full object-contain p-2"
                  />
                </div>
                <div className="flex items-center space-x-3 mb-2">
                  ...
                  <h3 className="font-bold text-on-surface text-sm">Other / Custom Service</h3>
                </div>
