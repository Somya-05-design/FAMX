...
function ForgotPasswordForm() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Success Alert */}
      {state?.success && (
        <div className="mb-6 p-4 rounded-xl bg-inverse-primary/20 border border-primary/20 text-primary text-xs flex items-center space-x-2">
      ...
      {/* Error Alert */}
      {state?.error && (
        <div className="mb-6 p-4 rounded-xl bg-error-container border border-error/30 text-on-error-container text-xs flex items-center space-x-2">
